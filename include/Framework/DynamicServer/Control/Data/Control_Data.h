...
//	METHODS **********************************************************************************************************************************************
// 	******************************************************************************************************************************************************
            void popFromStackOfInputPraises(class Data* obj, class Data_Input* referenceForCore, std::vector<class Data_Input*> ptr_InputStack, unsigned char coreId);
            void popFromStackOfOutput(class Data* obj_Data, class Data_Output* distributeBuffer, std::vector<class Data_Output*> outputStack);
            void pushToStackOfInputPraises(class Data* obj, std::vector<class Data_Input*> ptr_InputStack, class Data_Input* praiseBuffer);
            void pushToStackOfOutput(class Data* obj_Data, std::vector<class Data_Output*> outputStack, class Data_Output* referenceForCore, unsigned char coreId);
