...
// GET
            ...
            bool getFlag_ConcurrentCoreState(unsigned char coreId);

// SET
            void setFlag_ConcurrentCoreState(unsigned char coreId, bool value);
...
// 	******************************************************************************************************************************************************
            ...
            static bool flag_ConcurrentCoreState[2];//NUMBER OF CORES :: getInstance_Global()->get_NumCores()
