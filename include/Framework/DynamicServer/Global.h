...
//	GET & SET --------------------------------------------------------------------------------------------------------------------------------------------
        ...
        // Thread Control
            bool getConst_Core_IDLE(unsigned char index);
            bool getConst_Core_WAIT(unsigned char index);
            bool getConst_Core_ACTIVE(unsigned char index);
...
// 	******************************************************************************************************************************************************
            ...
            const bool core_IDLE[2]    = {false, false};
            const bool core_WAIT[2]    = {false, true};
            const bool core_ACTIVE[2]   = {true, false};
